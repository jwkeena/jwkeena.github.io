/*trying to get only unflipped cards to flip by designating them as flipped with a new id
function openPack() {
    for (i = 1; i <= 11 ; i++){
        let cardId = 'myDiv';
        cardId = cardId + i;
        let element = document.getElementById(cardId);
        if (element === document.getElementById('myDiv' + i)) {
            document.getElementById(cardId);
            element.classList.toggle("flipped");
            document.getElementById(cardId).id = 'myDivFlipped' + i;
        }
    } 
 } */

 /* trying to rewrite flip functions so that when flipped, they change the id to flip back
function flip1() {
    let cardId1 = document.getElementById('myDiv1');
    if (cardId1 = 'myDiv1') {
        element = document.getElementById(cardId1);
        element.classList.toggle('flipped');
        document.getElementById(cardId1).id = 'myDivFlipped1'
    } 
    if (cardId1 = 'myDivFlipped1') {
        element = document.getElementById(cardId1);
        element.classList.toggle('flipped');
        document.getElementById(cardId1).id = 'myDiv1'
    }
 } */
...
/*
    let flippedElement = document.getElementById('myDivFlipped1');
    flippedElement.classList.remove("flipped");
    let flippedElement2 = document.getElementById('randomCard1');
    flippedElement2.classList.remove("holographic");
    document.getElementById('myDivFlipped1').id = 'myDiv1'
*/
...
function newPackAlert() {
    document.getElementById('newPackAlert').innerHTML = 'new pack is ready to open!';
}
...
function newPackUnlimited(){
    ...
    for (i = 1; i <= 11 ; i++){
        ...
        newCardId= newCardId + i;
        let numOfLinks = (links[0].length);
        let randomNumber = Math.floor(Math.random()*numOfLinks);
        let newURL = links[0][randomNumber];
        document.getElementById(newCardId).src = newURL;
    }
    let randomHolographic = Math.floor(Math.random()*3);
...
function newPackAwakening(){
    ...
    for (i = 1; i <= 11 ; i++){
        let newCardId = 'randomCard';
        newCardId= newCardId + i;
        let numOfLinks = (links[1].length);
        let randomNumber = Math.floor(Math.random()*numOfLinks);
        let newURL = links[1][randomNumber];
        document.getElementById(newCardId).src = newURL;
    }
    let randomHolographic = Math.floor(Math.random()*3);
    if (randomHolographic === 2) {
...
function newPackDreamsEnd(){
    ...
    for (i = 1; i <= 11 ; i++){
        let newCardId = 'randomCard';
        newCardId= newCardId + i;
        let numOfLinks = (links[2].length);
        let randomNumber = Math.floor(Math.random()*numOfLinks);
        let newURL = links[2][randomNumber];
        document.getElementById(newCardId).src = newURL;
    }
    let randomHolographic = Math.floor(Math.random()*3);
    if (randomHolographic === 2) {
...
function newPackNightmaresDawn(){
    ...
    for (i = 1; i <= 11 ; i++){
        let newCardId = 'randomCard';
        newCardId= newCardId + i;
        let numOfLinks = (links[3].length);
        let randomNumber = Math.floor(Math.random()*numOfLinks);
        let newURL = links[3][randomNumber];
        document.getElementById(newCardId).src = newURL;
    }
    let randomHolographic = Math.floor(Math.random()*3);
    if (randomHolographic === 2) {
...
function newPackVoiceOfTheStorms(){
    ...
    for (i = 1; i <= 11 ; i++){
        let newCardId = 'randomCard';
        newCardId= newCardId + i;
        let numOfLinks = (links[4].length);
        let randomNumber = Math.floor(Math.random()*numOfLinks);
        let newURL = links[4][randomNumber];
        document.getElementById(newCardId).src = newURL;
    }
    let randomHolographic = Math.floor(Math.random()*3);
    if (randomHolographic === 2) {
...
//Creates an array of all possible links
const links = [
        
    //Nested array of Unlimited links at index 0
    ...
    'http://www.bluefurok.com/./BSImages/Evu.jpg',
    'http://www.bluefurok.com/./BSImages/Orwin.jpg',
    'http://www.bluefurok.com/./BSImages/Poad.jpg',
    'http://www.bluefurok.com/./BSImages/Pruitt.jpg',
    ...
    //Nested array of Awakening links at index 1
    ...
    //Nested array of Dreeam's End links at index 2
    ...
    //Nested array of Nightmare's Dawn links at index 3
    ...
    //Nested array of Voice of the Storms links at index 4
